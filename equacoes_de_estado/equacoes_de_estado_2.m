...
%{
    b) Assim, a matriz ϕ(s) = (sI−A)^−1 tem a forma ϕ(s) = 1/den(s)
    [ϕ11(s) ϕ21(s) ; ϕ12(s) ϕ22(s)]. Os coeficientes do polinômio
    den(s) e dos elementos ϕij(s) da matriz são:
%}
...
%{
    e) Consequentemente, considerando x(0) = 0, no instante t = 1s a
    saída y(t) do sistema vale:
%}
