...
%{
    Deseja-se realizar o projeto de um compensador de avanço para que o
    sistema a ser compensado tenha, em malha fechada com realimentação
    unitária, um sobressinal de 15% e tempo de acomodação de 0,5
    segundos para o critério de 2%.
